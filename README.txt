...
As from version 1.2.00 blueiriscmdj diverted from original blueiriscmd. For full list of cnd line commands have a look at [wiki](wiki/Command-Line-Arguments).  
Command line naming convention changed and additional functionality was added. All Classes have coresponding tests.
